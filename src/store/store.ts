...
// самое главное это функция  (makeStore)-создаёт для нас хранилище с которым мы взаимодействуем
// можно добавить настройки конфигураций (РАЗОБРАТЬСЯ глубже в теме)
